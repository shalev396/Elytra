export const landing = {
  ...
  features: {
    ...
    cicd: {
      title: "צינור CI/CD",
      description:
        "פריסות אוטומטיות עם GitHub Actions. בדוק, בנה, ופרוס בביטחון.",
    },
    state: {
      title: "ניהול מצב",
      description:
        "Redux Toolkit עם TypeScript. מקור אמת יחיד עם בוררים ו-middleware מיטביים.",
    },
    i18n: {
      title: "בינלאומיות",
      description:
        "תומך בשפות RTL ו-LTR. תמיכה מובנית באנגלית ועברית עם הרחבה קלה.",
    },
    email: {
      title: "שליחת אימייל",
      description:
        "אינטגרציה עם AWS SES לאימיילים טרנזקציוניים. תבניות, תזמון ומעקב כלולים.",
    },
    mfa: {
      title: "אימות דו-שלבי",
      description:
        "MFA מבוסס TOTP עם קודי QR. קודי גיבוי SMS לאבטחה משופרת.",
    },
    monitoring: {
      title: "ניטור ותצפית",
      description:
  ...
  cta: {
    ...
    description:
      "הצטרף למפתחים ששולחים מהר יותר עם Elytra. חינם, קוד פתוח, ומוכן לייצור.",
    button: "צור חשבון",
    docs: "קרא תיעוד",
  },
};
